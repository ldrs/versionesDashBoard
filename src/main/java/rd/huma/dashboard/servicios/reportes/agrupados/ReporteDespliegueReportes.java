...
public class ReporteDespliegueReportes extends Reporte {

	private ServicioJobDespliegueVersion servicioJobDespliegueVersion;

	public ReporteDespliegueReportes(ServicioJobDespliegueVersion servicioJobDespliegueVersion) {
		this.servicioJobDespliegueVersion = servicioJobDespliegueVersion;
	}

	@Override
	protected List<Object[]> ejecutaBusquedaReporte() {
		return servicioJobDespliegueVersion.buscaVersionesAgrupadasPorTipo(ETipoDespliegueJob.REPORTE);
	}
}